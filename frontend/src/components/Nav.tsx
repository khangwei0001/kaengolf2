...
export default function Nav() {
  ...
  const { lang, t, lp, altPath } = useI18n();
  ...
  return (
    ...
    >
      <div className="mx-auto max-w-[1400px] px-5 sm:px-8 h-[72px] flex items-center justify-between gap-6">
        {/* wordmark */}
        <Link to={lp('/')} className="shrink-0" aria-label="KAEN Performance Composite home">
        ...
        <div className="flex items-center gap-1 sm:gap-2">
          ...
          >
            ...
            <span className={lang === 'ja' ? 'text-bone' : ''}>日本語</span>
          </button>

          <button
            onClick={() => navigate(customer ? lp('/account') : lp('/login'))}
